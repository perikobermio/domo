...
class RangeColumn {
    ...
    onChange(position, nh) {
        ...
        this.fill.SetSize(this.size.w, this.size.h - this._percentToFloat(nh, this.minValue, this.maxValue, this.size.h))
